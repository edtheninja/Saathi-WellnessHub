      ...
      tracks: [
        {
          ...
          duration: "8:30",
          artist: "Zen Garden",
          src: `${import.meta.env.BASE_URL}Music/Tibetan.mp3`,
        },
        {
          title: "Crystal Singing",
          duration: "11:15",
          artist: "Healing Sounds",
          src: `${import.meta.env.BASE_URL}Music/Crystal.mp3`,
        },
        {
          title: "Peaceful Piano",
          duration: "9:42",
          artist: "Calm Keys",
          src: `${import.meta.env.BASE_URL}Music/Piano.mp3`,
        },
      ],
      ...
      tracks: [
        {
          ...
          src: `${import.meta.env.BASE_URL}Music/Moon.mp3`,
        },
        {
          title: "Forest Whispers",
          duration: "18:45",
          artist: "Bedtime Tales",
          src: `${import.meta.env.BASE_URL}Music/Forest.mp3`,
        },
        {
          title: "Ocean Journey",
          duration: "25:12",
          artist: "Dream Voyages",
          src: `${import.meta.env.BASE_URL}Music/Ocean.mp3`,
        },
      ],
